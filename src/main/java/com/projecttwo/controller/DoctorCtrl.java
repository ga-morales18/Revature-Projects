...
public class DoctorCtrl {
	...
	@RequestMapping(value="/insertdoctor", method=RequestMethod.GET, params = {"username", "password","firstName","lastName","license","street","city","state","zip"})
	public Doctor insertDoctor(String username,String password, String firstName,String lastName, String license, String street, String city, String state, String zip) {
		
		Doctor d = docService.insertDoctor(username, password, firstName, lastName, license, street, city, state, zip);
		return d;
	}
